...
<body>	
	<form class="ej" action="hiroad?cmd=getForm" method="POST" name="getForm" enctype="multipart/form-data">
		<div id="header">
			<div class="header_h">
			...
			<div class="write_set">
				...
				<div class="btn_img" title="이미지 첨부">
					<div class="mg filebox">
						...
						<label for="ex_filename"></label> <input type="file"
							name="file" id="ex_filename"  class="upload-hidden">
