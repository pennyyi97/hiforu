...
<div>
  <div class="nav">
    <button class="menu">왕십리역 6번 출구 ~ 정보관 ▽</button>
...
<script>            
  ...
  var marker_s = new Tmap.Marker(new Tmap.LonLat("127.039297", "37.561147").transform("EPSG:4326", "EPSG:3857"), icon);
  ...
  var size = new Tmap.Size(24, 38);
  var offset = new Tmap.Pixel(-(size.w / 1.9), -(size.h / 1.3));
  var icon = new Tmap.IconHtml('<img src=http://tmapapis.sktelecom.com/upload/tmap/marker/pin_r_m_e.png />', size, offset);
  var marker_e = new Tmap.Marker(new Tmap.LonLat("127.049294", "37.558303").transform("EPSG:4326", "EPSG:3857"), icon);
