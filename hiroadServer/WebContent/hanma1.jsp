...
<div class="lod" >
   ...
   /*  setInterval('autoRefresh_sample_div()', 8000);  */
</script>
	
	<div id="list">
		<ul class="name1">

			<c:forEach items="${list}" var="BusVO">
				<script>
				function time_differ_second(){
				      var depart_time = '${BusVO.depart_time}';
				      var result = time(depart_time);
				      document.getElementById("station1").innerHTML = result;
				}
			...
			<c:forEach items="${list2}" var="BusVO">
				<script>
				function time_differ_second(){
				      var depart_time = '${BusVO.depart_time}';
				      var result = time(depart_time);
				      document.getElementById("station2").innerHTML = result;
				}
				setInterval(time_differ_second,3000);
				</script>
				<li>한양대 3번 출구</li>
			...
			<c:forEach items="${list3}" var="BusVO">
				<script>
				function time_differ_second(){
				      var depart_time = '${BusVO.depart_time}';
				      var result = time(depart_time);
				      document.getElementById("station3").innerHTML = result;
				}
				setInterval(time_differ_second,3000);
				</script>
				<li>마장역 3번 출구</li>
