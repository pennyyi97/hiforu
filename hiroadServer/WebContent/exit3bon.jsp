...
<div>
  <div class="nav">
    <button class="menu">한양대역 3번 출구 ~ 본관 ▽</button>
 ...
 <script> 
  ...
  $(document).ready( function(){
	  $("#exit2").click(function(){
          location.replace('hiroad?cmd=exit2');
      })
  }) */
  map = new Tmap.Map({
      div : 'map_div',
...
var marker_s = new Tmap.Marker(new Tmap.LonLat("127.043744", "37.554496").transform("EPSG:4326", "EPSG:3857"), icon);
...
var marker_e = new Tmap.Marker(new Tmap.LonLat("127.049846", "37.558474").transform("EPSG:4326", "EPSG:3857"), icon);
