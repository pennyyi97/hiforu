...
<body>
   <jsp:include page="menubar.jsp" />
    <div id="wrap4">
		...
		<div id="mask4" ></div>
    	<div class="nav">
		    <button class="menu" type="button">행원파크식당</button>
		    <div class="tab">
			    <ul class="sub">
	...
	<div class="area">
		<div class="titlev">
	       <div class="head">
	          <dl class="w">
	             <dt>위치</dt>
	             <dd>행원파크 지하 1층 B104</dd>
	             <dt class="tel">전화</dt>
	             <dd>02-2290-2762</dd>
	             <dt class="time">운영시간</dt>
	             <dd class="indent2">교직원·학생 11:30~19:00(18:50 주문마감)</dd>
	          </dl>
	       </div>
       </div>
    <!--   <div style="margin-bottom:-30px;">
          <a href="https://www.hywoman.ac.kr/ko/cms/CM_ML01_CON/CM_ML01_V01.do?MENU_SN=327">
